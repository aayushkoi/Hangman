...
Status test_ak_destroy_changes_handle_to_NULL(char* buffer, int length)
{
	MY_STRING hString = NULL;
	Status status;
	int* x;
	...
	{
		strncpy(buffer,
				"test_ak_destroy_changes_handle_to_NULL\n"
...
Status test_ak_compare_works_with_non_alphanumeric_characters(char* buffer, int length)
{
	...
	{
		strncpy(buffer,
				"test_ak_compare_works_with_non_alphanumeric_characters\n"
...
Status test_ak_my_string_c_str_returns_address_of_data(char* buffer, int length)
{
	...
	{
		strncpy(buffer,
				"test_ak_my_string_c_str_returns_address_of_data\n"
...
Status test_ak_my_string_pop_back_reduces_size(char* buffer, int length)
{
	MY_STRING hMy_string = NULL;
	Status status;
	...
	{
		strncpy(buffer,
				"test_ak_my_string_pop_back_reduces_size\n"
...
Status test_ak_my_string_empty_confirms_on_popped_back_string(char* buffer, int length)
{
	MY_STRING hMy_string = NULL;
	Status status;
	hMy_string = my_string_init_c_string("StarLight");
	...
	{
		strncpy(buffer,
				"test_ak_my_string_empty_confirms_on_popped_back_string\n"
...
Status test_ak_my_string_concat_properly_adjusts_size(char* buffer, int length)
{
	...
	{
		strncpy(buffer,
				"test_ak_my_string_concat_properly_adjusts_size\n"
...
Status test_ak_my_string_c_str_does_not_change_size(char* buffer, int length)
{
	MY_STRING hMy_string = NULL;
	Status status;
	hMy_string = my_string_init_c_string("StarLight");
	...
	{
		strncpy(buffer,
				"test_ak_my_string_c_str_does_not_change_size\n"
...
Status test_ak_my_string_at_correctly_returns_address(char* buffer, int length)
{
	MY_STRING hMy_string = NULL;
	...
	{
		strncpy(buffer,
				"test_ak_my_string_at_correctly_returns_address\n"
...
Status test_ak_compare_returns_0(char* buffer, int length)
{
	...
	{
		status = SUCCESS ;
		strncpy( buffer, "test_ak_compare_returns_0\n", length ) ;
	}
	else
	{
		status = FAILURE ;
...
Status test_ak_compare_returns_greater_than_0(char *buffer, int length)
{
	...
	if ( my_string_compare( hLeft_string, hRight_string ) > 0 )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_compare_returns_greater_than_0\n", length ) ;
...
Status test_ak_compare_returns_less_than_0(char *buffer, int length)
{
	MY_STRING hLeft_string = NULL ;
	MY_STRING hRight_string = NULL ;
	Status status ;
	...
	if ( my_string_compare( hLeft_string, hRight_string ) < 0 )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_compare_returns_less_than_0\n", length ) ;
...
Status test_ak_concat_allocates_additional_memory(char *buffer, int length)
{
	...
	if ( capacity < my_string_get_size( lhString ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_concat_allocates_additional_memory\n", length ) ;
...
Status test_ak_concat_returns_success(char *buffer, int length)
{
	MY_STRING lhString = NULL ;
	MY_STRING rhString = NULL ;
	Status status ;
	...
	if ( my_string_concat( lhString, rhString ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_concat_returns_success\n", length ) ;
...
Status test_ak_concat_returns_success_with_empty_string(char *buffer, int length)
{
	MY_STRING lhString = NULL ;
	MY_STRING rhString = NULL ;
	Status status ;
	...
	if ( my_string_concat( lhString, rhString ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_concat_returns_success_with_empty_string\n", length ) ;
...
Status test_ak_empty_returns_false_on_a_nonempty_string(char *buffer, int length)
{
	MY_STRING hString = NULL ;
	Status status ;
	...
	if ( !( my_string_empty( hString ) ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_empty_returns_false_on_a_nonempty_string\n", length ) ;
...
Status test_ak_empty_returns_true_on_an_empty_string(char *buffer, int length)
{
	MY_STRING hString = NULL ;
	Status status ;
	...
	if ( my_string_empty( hString ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_empty_returns_true_on_an_empty_string\n", length ) ;
...
Status test_ak_pop_back_decrements_size(char *buffer, int length)
{
	...
	if ( size_0 - 1 == size_1  )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_pop_back_decrements_size\n", length ) ;
...
Status test_ak_pop_back_returns_success_on_a_nonempty_string(char *buffer, int length)
{
	MY_STRING hString = NULL ;
	Status status ;
	...
	if ( my_string_pop_back( hString ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_pop_back_returns_success_on_a_nonempty_string\n", length ) ;
...
Status test_ak_pop_back_returns_failure_on_an_empty_string(char *buffer, int length)
{
	MY_STRING hString = NULL ;
	Status status ;
	...
	if ( !( my_string_pop_back( hString ) ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_pop_back_returns_failure_on_an_empty_string\n", length ) ;
...
Status test_ak_push_back_allocates_additional_memory(char *buffer, int length)
{
	MY_STRING hString = NULL ;
	Status status ;
	int capacity ;
	...
	if ( capacity < my_string_get_capacity( hString ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_push_back_allocates_additional_memory\n", length ) ;
...
Status test_ak_push_back_returns_success(char *buffer, int length)
{
	MY_STRING hString = NULL ;
	Status status ;
	...
	if ( my_string_push_back( hString, '.' ) )
	{
		...
		status = SUCCESS ;
		strncpy( buffer, "test_ak_push_back_returns_success\n", length ) ;
